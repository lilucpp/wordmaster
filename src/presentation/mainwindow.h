...
#include "infrastructure/repositories/word_tag_repository.h"
...
private:
    ...
    NotebookWidget* notebookWidget_;
    ...
    std::unique_ptr<Infrastructure::WordTagRepository> tagRepo_;
    ...
    std::unique_ptr<Application::TagService> tagService_;
